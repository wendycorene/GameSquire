//
//  LoadCreatorSpecificShopTableViewController.swift
//  GameSquire
//
...
class LoadCreatorSpecificShopTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "shopItemOwner", for: indexPath)
